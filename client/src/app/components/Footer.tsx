      ...
      <div className="w-full max-w-7xl mx-auto px-6 py-12 grid md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Practical, hands-on courses to level up your programming skills and launch your dev career.
          </p>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p>Email: support@codemy.com</p>
          <p>Phone: +1 (555) 123-4567</p>
          <p>Address: 123 Dev Street, Tech City</p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <form className="w-full flex flex-col sm:flex sm:flow-row gap-2 py-2">
            <input
              type="email"
              placeholder="Your email"
              className="flex-1 px-3 py-2 rounded-md border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-purple-500 dark:bg-gray-800 dark:text-white"
            />
            <button className="px-4 py-2 bg-purple-600 text-white rounded-md hover:bg-purple-700 active:scale-[0.95] transition cursor-pointer duration-300 delay-75">
              Subscribe
            </button>
          </form>
        </div>
